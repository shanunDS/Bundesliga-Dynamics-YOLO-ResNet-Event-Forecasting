...
# def main():
#     # Read Video
#     video_frames = read_video('clips/08fd33_4.mp4')
#
#     # Initialize Tracker
...
def main():
    ...
    if uploaded_file is not None:
        ...
        # Save Video
        # save_video(output_frames, 'C:/Users/kalya/OneDrive/Desktop/Project_DL/DL/clips_output/output.avi')
        #
        # st.text("Video processed successfully. You can download the output file below.")
        # st.download_button(label="Download Output Video", data='C:/Users/kalya/OneDrive/Desktop/Project_DL/DL/clips_output/', file_name="output123.avi")
